(function() {
  ...
  module.exports = TranspositionTable = (function() {
    function TranspositionTable(game, log_size) {
      ...
      this.xor_table_b = new Array(this.game.nn * 3 + 2);
      i = 0;
    ...
    TranspositionTable.prototype.update_zobrist_stamp_for_current_player_change = function() {
      this.game.zobrist_a ^= this.xor_table_a[this.game.n + 2 + this.game.current_player] ^ this.xor_table_a[this.game.n + 2 - this.game.current_player];
      return this.game.zobrist_b ^= this.xor_table_b[this.game.n + 2 + this.game.current_player] ^ this.xor_table_b[this.game.n + 2 - this.game.current_player];
    };
    TranspositionTable.prototype.reset_zobrist_stamp_for_game = function() {
      var i, _results;
      this.game.zobrist_a = this.xor_table_a[this.game.n + 2 + this.game.current_player];
      this.game.zobrist_b = this.xor_table_b[this.game.n + 2 + this.game.current_player];
      i = 0;
      _results = [];
