(function() {
  ...
  module.exports = TranspositionTableEntry = (function() {
    function TranspositionTableEntry(player, depth, position_value, position_value_type, best_move, zobrist_b, zobrist_c, search_id) {
      this.player = player;
      this.depth = depth;
      this.position_value = position_value;
      this.position_value_type = position_value_type;
      this.best_move = best_move;
      this.zobrist_b = zobrist_b;
      this.zobrist_c = zobrist_c;
