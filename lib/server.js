(function() {
  ...
  module.exports = Server = (function() {
    function Server(n, games_in_a_tournament) {
      this.n = n;
      this.games_in_a_tournament = games_in_a_tournament != null ? games_in_a_tournament : 400;
    ...
    Server.prototype.log_tournament_results = function() {
      ...
      return console.log(" * as white I've won " + this.won_as_white + " times and lost " + this.lost_as_white + " times!");
    };
    return Server;
  })();
}).call(this);
